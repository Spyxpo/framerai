 ...
 */
async function processMessage(messages, requestType = "text", settings = {}, requestId = null) {
  ...
  if (bridge.available()) {
    try {
      return await modelChat(intent, content, settings, requestId);
    } catch (err) {
...
async function modelChat(intent, content, settings = {}, requestId = null) {
